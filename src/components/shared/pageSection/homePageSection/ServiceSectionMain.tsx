...
export default function ServiceSectionMain() {
  return (
    <div className="relative">
      <div className="relative py-32 z-10 w-full mx-auto max-w-[1210px]">
