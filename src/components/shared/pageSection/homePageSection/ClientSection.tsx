...
export default function ClientSection() {
  return (
    <div className="py-14 w-full max-w-[1210px] mx-auto">
      ...
      <div className="w-[100%] flex items-center justify-center mx-auto py-14">
        <Swiper
          spaceBetween={20}
          loop={true}
        ...
        >
          {Testimonial.map((data) => (
            <SwiperSlide key={data.id}>
              <div className="flex flex-col px-6 py-4 items-start justify-center space-y-1 rounded-3xl bg-darkpurple xl:w-[370px] xl:h-[280px] lg:w-[310px] lg:h-[260px]">
                <HeaderMedium
                  color="white"
                  fontSize="20"
